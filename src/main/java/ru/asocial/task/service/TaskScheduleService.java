...
import ru.asocial.task.dto.ScheduleCreateRequest;
import ru.asocial.task.dto.ScheduleResponse;
import ru.asocial.task.dto.ScheduleTableRowResponse;
...
import ru.asocial.task.repository.TaskScheduleRepository;
...
public class TaskScheduleService {
	...
	public TaskScheduleService(TaskScheduleRepository taskScheduleRepository, TaskService taskService) {
	...
	private void triggerSchedule(TaskSchedule schedule, LocalDateTime now) {
		TaskCreateRequest request = new TaskCreateRequest(schedule.getTaskType(), schedule.getFormula());
